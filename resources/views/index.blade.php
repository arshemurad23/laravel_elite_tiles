...
<head>
  <title>Elite Tiles | Website.</title>
  <meta charset="utf-8">
...
<div>
  ...
  <header id="header">
    ...
    $highlighted = str_replace(
        'Elite Tiles',
        'Elite <span class="text-primary">Tiles</span>',
        $contact_list->definition
    );
@endphp

<marquee behavior="" direction="">
    <p style="text-align: center; font-family: 'Segoe UI', Tahoma, Geneva, Verdana;">
        {!! $highlighted !!}
    </p>
</marquee>
            ...
            <div class="offcanvas-body align-items-center justify-content-center">
              ...
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                <li class="nav-item px-3">
                  <a class="nav-link active p-0" aria-current="page" href="{{URL::to('/')}}">Home</a>
                </li>

                <li class="nav-item px-3 dropdown">
                 <a class="nav-link p-0 dropdown-toggle text-center" href="#" role="button" aria-expanded="false">Categories</a>
                  <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                  
@foreach($categories as $categorie)
    <li>
        <a href="{{ url('home/categorie/'.$categorie->categories) }}" class="dropdown-item">
...
@endforeach
  ...
  <section id="slider" data-aos="fade-up">
    <div class="container-fluid padding-side">
      <div class="d-flex rounded-5"
        style="background-image: url(assets/images/tile-panel-ECohen-WEB-2.jpg); background-size: 100%100%; background-repeat: no-repeat; height: 80vh; background-position: center;">
        <div class="row align-items-center m-auto pt-5 px-4 px-lg-0">
          <div class="text-start col-md-6 col-lg-5 col-xl-6">
           <h2 class="display-1 fw-normal text-light">Transform Your Space with the Elegance of Elite Tiles.</h2>
            <a href="{{ URL::to('categorie-rooms-Tiles') }}" class="btn btn-arrow btn-primary mt-3">
            <span>Explore rooms 
  ...
  <section id="about-us" class="m-5">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <h3 class="display-3 text-center fw-normal col-lg-4 offset-lg-4">Grace Your Walls with Stories in Stone.</h3>
      <div class="row align-items-start mt-3 mt-lg-5">
        <div class="col-lg-6">
          <div class="p-5">
            <p>Welcome to Elite Tiles, where every space tells a story. Explore our curated collections for your bathroom, kitchen, and bedroom — crafted to bring elegance, function, and lasting beauty into your home.</p>
            <a href="{{URL::to('home/about')}}" class="btn btn-arrow btn-primary mt-3">
              <span>Read About Us <svg width="18" height="18">
                  <use xlink:href="#arrow-right"></use>
                </svg></span>
            </a>
          </div>
          <img src="assets/images/c1.png" alt="img" class="img-fluid rounded-4 mt-4">
        </div>
        <div class="col-lg-6 mt-5 mt-lg-0">
          <img src="assets/images/c2.png" alt="img" class="img-fluid rounded-4">
          <img src="assets/images/c3.png " alt="img" class="img-fluid rounded-4 mt-4">
  ...
  <div class="col-md-2 mb-4">
    <h3 class="display-1 fw-normal text-primary position-relative">
      ...
      <span class="position-absolute top-50 end-50 translate-middle z-n1 ps-lg-4 pt-lg-4">
        <img src="assets/images/pattern1.png" alt="pattern" class="img-fluid">
      </span>
    </h3>
  ...
  @foreach($floor_tiles->take(6) as $floor_tile)

    <div class="swiper-slide">
      <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
        <img src="{{ asset('assets/images/b1.png') }}" class="post-image img-fluid rounded-4" alt="img" />
        
        <div class="product-description position-absolute p-5 text-start">
          <h4 class="display-6 fw-normal text-white">{{ $floor_tile->name }}</h4>
          <table>
            <tbody>
              <tr class="text-white">
                <td class="pe-2">Finish:</td>
                <td>{{ $floor_tile->finish }}</td>
            </tr>
            </tbody>
          </table>

          <a href="{{ url('home/categorie/' . $floor_tile->name . '/info' ) }}" class="btn-arrow">
      ...
      <div class="room-content text-center mt-3" style="padding: 30px;">
        <p><span class="text-primary fs-4">Size:</span> {{ $floor_tile->size }}</p>
      </div>
    </div>
@endforeach
  ...
  <section id="gallery" data-aos="fade-up">
    <h3 class="display-3 fw-normal text-center">kitchen Collection</h3>
    <p class="text-center col-lg-4 offset-lg-4 mb-5">Upgrade your kitchen with our stylish and durable Kitchen Collection tiles—resistant to stains, moisture, and heat, they blend modern looks with lasting 

 <a href="{{ URL::to('categorie-Kitchen-Tiles') }}" class="btn btn-arrow btn-primary mt-3">
          <span>Explore kitchens<svg width="18" height="18">
              <use xlink:href="#arrow-right"></use>
            </svg></span>
        </a></p>
    <div class="container position-relative">
      <div class="row">
        <div class="swiper gallery-swiper offset-1 col-10">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="assets/images/k1.png" alt="img" class="img-fluid rounded-4">
            </div>
            <div class="swiper-slide">
              <img src="assets/images/k2.png" alt="img" class="img-fluid rounded-4">
            </div>
            <div class="swiper-slide">
              <img src="assets/images/k3.png" alt="img" class="img-fluid rounded-4">
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- washroom start -->
  <section id="blog" class="padding-medium  mt-5">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div>
          <h3 class="display-3 fw-normal text-center">Explore the Washroom Collection</h3>
        </div>
        <a href="{{ URL::to('categorie-Washroom-Tiles') }}" class="btn btn-arrow btn-primary mt-3">
          <span>Explore Washrooms<svg width="18" height="18">
              <use xlink:href="#arrow-right"></use>
            </svg></span>
        </a>
      </div>
  ...
  @foreach($washroom_tiles->take(4) as $washroom_tile)

 <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            <img src="{{ $washroom_tile->img1 }}" class="blog-img img-fluid rounded-4" alt="img">
            <div class="position-absolute bottom-0 p-5">
              <a href="#"><span class="bg-secondary text-body m-0 px-2 py-1 rounded-2 fs-6">{{ $washroom_tile->finish }}</span></a>
              <h4 class="display-6 fw-normal mt-2"><a href="index.html">{{ $washroom_tile->name }}</a></h4>
              <p class="m-0 align-items-center text-dark"><svg width="19" height="19">
               <span>Size:</span>
                </svg> {{ $washroom_tile->size }}</p>

                   <a href="{{ url('home/categorie/' . $washroom_tile->name . '/info' ) }}" class="btn-arrow">
            <p class="text-decoration-underline text-white m-0 mt-2">
              <span>
                More Details
                <svg width="18" height="18">
...
@endforeach
        ...
        <div class="col-md-6 col-lg-8 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            <img src="assets/images/b4.png" class="blog-img img-fluid rounded-4" alt="img">
            <div class="position-absolute bottom-0 p-4">
              <a href="#"><span class="bg-secondary text-body m-0 px-2 py-1 rounded-2 fs-6">Card</span></a>
              <h4 class="display-6 fw-normal mt-2"><a href="index.html"></a></h4>
  ...
  <div class="service mb-4 text-center rounded-4 p-5">
    ...
    <h4 class="display-6 fw-normal my-3">Tile Fixer Available</h4>
    <p>Looking for professional tile installation?  Our expert tile fixers ensure flawless fitting with precision and care. Whether it's wall, floor, or custom tile work, we guarantee a smooth and lasting finish every time.</p>
  ...
  <div class="service mb-4 text-center rounded-4 p-5">
    ...
    <h4 class="display-6 fw-normal my-3">Plumber Available</h4>
    <p>Need help with tile installation Sanitary or pipe fittings? Our expert plumbers are just a call away—offering fast, reliable service to ensure your kitchen or bathroom is set up perfectly. Quality workmanship, guaranteed.</p>
    <a href="index.html" class="btn btn-arrow">
      <span class="text-decoration-underline">Read More<svg width="18" height="18">
          <use xlink:href="#arrow-right"></use>
        </svg></span>
        ...
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            ...
            <h4 class="display-6 fw-normal my-3">Customer Guidance</h4>
            <p>Need guidance choosing the right tiles or have a question post-purchase? Our support team is always ready to assist with expert advice, quick help, and reliable service—every step of the way.</p>
            <a href="index.html" class="btn btn-arrow">
              <span class="text-decoration-underline">Read More<svg width="18" height="18">
                  <use xlink:href="#arrow-right"></use>
                </svg></span>
