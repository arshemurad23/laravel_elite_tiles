        ...
        <div class="row mt-4">
            <div class="col-md-6 offset-md-3">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ url('service/add/form') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="info" id="info" class="form-control" rows="8" placeholder="Enter Info" required></textarea>
                            </div>
